...
if __name__ == "__main__":
    data_source = "/mnt/public/gpfs-jd/data/RL_Data/origin/Science_caption2mol"
    ...
    print(test_data)
    print(test_data[0])
    local_dir = "/mnt/public/gpfs-jd/data/RL_Data/RL_Train_v2/caption2mol"
    sft_dataset.to_parquet(os.path.join("/mnt/public/gpfs-jd/data/SFT_Data/caption2mol_v2", "train.parquet"))
    rl_dataset.to_parquet(os.path.join(local_dir, "train.parquet"))
    test_data.to_parquet(os.path.join(local_dir, "test.parquet"))
    #test_data.save_to_disk("/mnt/public/gpfs-jd/data/RL_Data/eval_data/science_caption2mol")
