...
if __name__ == "__main__":
    ...
    datasets_split = datasets.train_test_split(test_size=0.05, seed=42)
    ...
    print(test_data)
    print(test_data[0])
    output_path = "/mnt/public/gpfs-jd/data/RL_Data/RL_Train_v3/science/"
    train_data.to_parquet(os.path.join(output_path+"webinstruct-split-13k", "train.parquet"))
    test_data.to_parquet(os.path.join(output_path+"webinstruct-split-13k", "test.parquet"))
