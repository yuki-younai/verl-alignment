...
if __name__ == "__main__":
    sft_data_source = "/mnt/public/gpfs-jd/data/RL_Data/science_data/mol2caption_sft"
    rl_data_source = "/mnt/public/gpfs-jd/data/RL_Data/science_data/mol2caption_rl"
    ...
    # sft_dataset.to_parquet(os.path.join("/mnt/public/gpfs-jd/data/SFT_Data/SFT_data_v3/mol2caption-full-18k", "train.parquet"))
    # rl_dataset_train.to_parquet(os.path.join("/mnt/public/gpfs-jd/data/RL_Data/RL_Train_v3/mol2caption-full-17k", "train.parquet"))
    # rl_dataset_test.to_parquet(os.path.join("/mnt/public/gpfs-jd/data/RL_Data/RL_Train_v3/mol2caption-full-17k", "test.parquet"))
    # test_dataset.save_to_disk("/mnt/public/gpfs-jd/data/RL_Data/eval_data/science_mol2caption")
    print(rl_dataset_train_split)
    rl_dataset_train_split.to_parquet(os.path.join("/mnt/public/gpfs-jd/data/RL_Data/RL_Train_v3/mol2caption-split-6k", "train.parquet"))
    rl_dataset_test.to_parquet(os.path.join("/mnt/public/gpfs-jd/data/RL_Data/RL_Train_v3/mol2caption-split-6k", "test.parquet"))
