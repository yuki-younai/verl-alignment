...
if __name__ == '__main__':
    ...
    test_dataset = train_dataset.select(range(600))
    train_dataset.to_parquet(os.path.join(output_path+"leetcode2k", "train.parquet"))
    test_dataset.to_parquet(os.path.join(output_path+"leetcode2k", "test.parquet"))
    test_dataset.save_to_disk("/mnt/public/gpfs-jd/data/RL_Data/eval_data/leetcode2k")
